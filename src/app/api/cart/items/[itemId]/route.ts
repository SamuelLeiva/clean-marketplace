...
export async function PUT(
  ...
  try {
    const userId = await getUserIdFromRequest(req) // Aquí integrarías tu lógica de autenticación
    ...
    const updatedCartItem = await useCase.execute(userId, itemId, input)
